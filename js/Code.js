...
// add code for displaying rest of the names and the hints.
    ...
    fill("white")
    textSize(15)
    text("A T A D A S B A", 650,150)
    fill("lightblue")
    text("Hint: Place for storing and reading information !!", 650,170)
    
    fill("white")
    textSize(15)
    text("C U T N I F O N", 400,350)
    fill("lightblue")
    text("Hint: Used to create code to carry out a task !!", 400,370)
